...
router.post("/ziGratis", async (req, res) => {
  ...
  if (checkAvailability === null) {
    ...
    const sendSmtpEmail = new SibApiV3Sdk.SendSmtpEmail({
        sender: {
          name: "Burn Fitness Cluj",
          email: "burnclujfake@gmail.com"
        },
        to: [{
            ...
            <tr>
              <td align="center">
                <table width="300" cellpadding="0" cellspacing="0" border="0" style="background: #000; border-radius: 10px; padding: 15px 15px 40px 15px;">
                  ...
                  <tr>
                    <td align="center">
                      <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${req.body.email}" 
                           width="200" height="200" style="padding-bottom: 20px"/>
                    </td>
                  </tr>
                  <tr>
                    <td align="center">
