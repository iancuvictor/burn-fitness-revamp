function CardSala(props){
    return <div className='relative w-[30%] bg-black font-finlandica cursor-pointer rounded-xl overflow-hidden relative flex flex-col justify-center items-center'>
        <div className=" z-1 absolute top-0 w-full h-full md:opacity-40 md:bg-black hover:opacity-0 duration-150"></div>
        <div className='relative w-full'>
        <img src={props.img} alt="Imagine sală"  className='w-full h-80 object-cover object-top select-none'/>
