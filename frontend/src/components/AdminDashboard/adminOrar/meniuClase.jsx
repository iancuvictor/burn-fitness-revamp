...
export default function MeniuClase({ popUp, setPopUp }) {
    ...
    return <div className='font-finlandica'>
        ...
        z-2 fixed top-0 left-0 h-full w-full bg-black/80`}>
            <div className='bg-white p-5 rounded-md flex flex-col gap-5 h-140 w-200 overflow-y-scroll'>
                ...
                <div className='flex flex-row gap-5'>
                    <div className='flex flex-col gap-2 w-[65%]'>
                        ...
                        <div data-color-mode="light" className="w-full h-fit">
                            <MDEditor
                    ...
                    <div className='flex flex-col gap-1 h-100 overflow-y-scroll w-[35%]'>
