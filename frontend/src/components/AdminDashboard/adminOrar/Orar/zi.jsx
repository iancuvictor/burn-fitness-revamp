...
function Zi({ locatie, dataOrar, zi, ziOrar, getOrar, selectors }) {
  ...
  return <div className="w-full flex flex-col min-h-100 p-[20px] font-finlandica gap-5 shadow-xl">
    ...
    <div className='flex items-center gap-3'>
      ...
      }} className="flex items-center justify-center pt-[5px] pb-[5px] w-10 text-[18px] shadow-md hover:shadow-xl cursor-pointer 
    ...
    <div className='flex flex-col gap-1'>
      {dataOrar.filter((clasa) => new Date(clasa.data).toLocaleDateString() === ziOrar)
        .sort((a, b) => new Date(a.data) - new Date(b.data)).map((clasa, index) => {
