...
function AdminNavbar(){
    ...
    return <div id='navbar' className={`sticky top-0 left-0 shadow-md z-2 flex flex-row items-between top-0 w-full h-20 gap-5 bg-white items-center justify-between`}>
