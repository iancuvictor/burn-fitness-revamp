...
export default function CardClase({data}) {
  return (
    <NavLink to={`/clasa/${data._id}`}
      ...
      w-fit h-[50%] md:w-xs md:h-70 font-finlandica rounded-xl overflow-hidden"
    >
      ...
      <div className="relative flex flex-col justify-baseline items-center w-full md:w-xs h-90 overflow-hidden">
        <img
          ...
          alt=""
          className="w-full md:h-100 md:group-hover:scale-120 duration-400 ease-out object-cover object-center select-none"
        />
