...
export default function Clase() {
  ...
  return (
    ...
    <div className={`w-full flex flex-row flex-wrap justify-center items-center gap-2 duration-400 ease-out`}>
      {selectors.clase.sort((a, b) => a.nume > b.nume).map((clasa, index) => {
